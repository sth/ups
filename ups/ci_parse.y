...
%type <statement> compound_statement compound_statement_body
...
function_definition
	...
	} LBRACE compound_statement_body {
		ci_end_func($4);
	}
...
function_declaration
	...
	| declaration_specifiers declarator {
		...
		dn = ci_make_declaration($1->dn_class, ci_get_dn_basetype($1),
					 $1->dn_qualifiers, $2);
		$$ = ci_start_func(dn);
	}
...
declaration_specifiers
	: storage_class_specifier {
		$$ = ci_make_declaration($1, (type_t *)NULL, 0,
						(declarator_t *)NULL);
	}
...
struct_or_union_specifier
	: struct_or_union {
		...
		Labels_allowed = TRUE;
		$$ = ci_build_aggr_or_enum_def($1, (identifier_t *)NULL,
				AE_COMPLETE, $4, (enum_member_t *)NULL, FALSE);
	}
...
struct_declaration
	: specifier_qualifier_list struct_declarator_list SEMI {
		$$ = ci_make_declaration($1->dn_class, ci_get_dn_basetype($1),
					 $1->dn_qualifiers, $2);
	}
...
direct_declarator
	...
	| direct_declarator LPAREN identifier_list RPAREN {
		$$ = ci_make_funcret_type($1, FDT_IDLIST,
...
type_name
	: specifier_qualifier_list {
		$$ = ci_get_dn_basetype($1);
	}
	| specifier_qualifier_list abstract_declarator {
		$$ = ci_push_types(ci_get_dn_basetype($1), $2->dr_type);
	}
...
compound_statement
	: start_block compound_statement_body {
		$$ = $2;
	}

compound_statement_body
	: compound_statement_declarations RBRACE {
		$$ = ci_end_compound_statement((statement_t *)NULL);
	}
	| compound_statement_declarations statement_list RBRACE {
		$$ = ci_end_compound_statement($2);
	}
