...
#define INTHEX  0xFFFF      /* 2^16 - 1 */
   ...
   /* Brought upto ISO C stantards by Ed Breen K&R2 A2.5.1*/

     /* A decimal constant whose value exceeds the largest signed
        machine integer is taken to be long; an octal or hex con-
        stant which exceeds the largest signed machine integer
        is likewise taken to fit unsigned int, long, unsigned.     */

   if ( sizeof INTDEC != sizeof(long)      /* 2**30 */
     || sizeof INTHEX != sizeof(unsigned int) ){   /*   "   */
...
long 
pow2 (        /* Calculate 2**n by multiplying, not shifting  */
    long n
)
{
   long s;
...
int 
s243 (                   /*  2.4.3 Character constants  */
    struct defs *pd0
)
{
...
int 
s26 (                  /*  2.6  Hardware Characteristics     */
    struct defs *pd0
)
{
...
int 
zero (void){                 /* Returns a value of zero, possibly */
#ifndef __CXC__
...
int 
s714 (          /*  7.14  Assignment operators       */
    struct defs *pd0
)
{
...
int 
s7813 (          /* 7.8 Bitwise AND operator
...
int 
s81 (              /* 8.1 Storage Class Specifiers    */
    struct defs *pd0
)
{
...
int 
regc (void) {     /*   char to register assignment   */
...
int 
regi (void) {     /*   int to register assignment    */
/*   Testing a variable whose storage class has been spec-
ified as "register" is somewhat tricky, but it can be done in a 
fairly reliable fashion by taking advantage of our knowledge of the
ways in which compilers operate. If we declare a collection of vari-
...
int 
regp (void) {     /*   pointer to register assignment   */
/*   Testing a variable whose storage class has been spec-
ified as "register" is somewhat tricky, but it can be done in a 
fairly reliable fashion by taking advantage of our knowledge of the
ways in which compilers operate. If we declare a collection of vari-
...
int 
array (int a[], int size, int start)
{
   int i;
   for(i=0; i<size; i++)
...
int 
s84 (          /*  8.4 Meaning of declarators   */
    struct defs *pd0
)
{
   int *ip, i, (*pfi)(int x), j, k, glork(int x);
...
{return x;}
int 
s85 (          /*  8.5 Structure and union declarations   */
    struct defs *pd0
)
{
...
int 
setev (void){                  /* Sets an external variable. Used  */
