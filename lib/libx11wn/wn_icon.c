...
/* @(#)wn_icon.c	1.18 4/11/93 (UKC) */
char wn_wn_icon_c_rcsid[] = "$Id$";
...
int wn, x, y, width, height;
{
	...
	XChangeWindowAttributes(wn__Dpy, iw->w_win,
...
int wn;
{
	...
	wn_set_area(wn, x, y, BLOB_WIDTH, BLOB_HEIGHT, WN_FG(wn));
