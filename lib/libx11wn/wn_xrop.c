...
/* @(#)wn_xrop.c	1.13 1/3/93 (UKC) */
char wn_wn_xrop_c_rcsid[] = "$Id$";
 ...
 *  if necessary.
 *
 *  fg & bg should have been translated with PIX() before the call.
 */ 
void
...
xpixel_t fg, bg;
{
	...
	XSetState(wn__Dpy, gc, fg, bg, _wn_Roptab[ropfunc], AllPlanes);
