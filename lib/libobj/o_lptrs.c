...
/*  RGA Return the indentation in pixels of obj from the given object 
 *  above. Return 0 if given object not a parent
 */
int
get_indent_from_objtype(obj, type)
struct objst *obj;
int type;
{
	struct objst *par;
